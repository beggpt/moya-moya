      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-neutral-300 rounded-xl hover:bg-neutral-50 transition-colors min-h-[48px] text-sm font-medium text-neutral-700"
          >
